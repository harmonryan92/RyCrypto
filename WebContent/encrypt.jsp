...
<body>
	...
	<div class="main">
		<form action="ControllerServlet" method="POST">
			...
			<h3>Create a 16-character password for encryption. This will also be used for decryption. </h3>
			<h4>*Password may contain spaces, numbers, or special characters.</h4>
